...
//ini route laporan
Route::get('/admin/laporan', [LaporanController::class, 'index']);//menamplkan halaman laporan
Route::get('/admin/laporan/barang', [LaporanController::class, 'cetak_barang']);//untuk cetak barang
